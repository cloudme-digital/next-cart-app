...
//   }
// }
// For differebt colors and sizes: add the previous lines inside VariableProduct above (just before variations).
// Futhermore, update "src/components/Product/AddToCart.component.tsx"
